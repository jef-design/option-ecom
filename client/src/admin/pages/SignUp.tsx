  ...
  return (
   <>
    ...
    <div className=' max-w-[458px] w-full mt-9 mx-auto border rounded-md p-5 bg-white'>
        <div>
            <h3 className=' text-center font-bold text-lg'>Register as an Admin</h3>
        </div>
        ...
        {/* <div className='flex flex-col mb-2'>
                ...
                <input style={isError ? { border: '1px solid red' } : {}} value={name} className='border p-2 mt-2' onChange={(e) => {setName(e.target.value)}} type="text" />
